...
const CATALOG = {
  character: {
    ...
    abyssinian: { name: "아비시니안", price: 20, atlas: "extra", col: 0, row: 0 },
    bengal: { name: "뱅갈", price: 20, atlas: "extra", col: 1, row: 0 },
    ragdoll: { name: "렉돌", price: 20, atlas: "extra", col: 2, row: 0 },
    ...
    jindo: { name: "진돗개", price: 20, atlas: "extra", col: 0, row: 1 },
    pug: { name: "퍼그", price: 20, atlas: "extra", col: 1, row: 1 },
    pompitz: { name: "폼피츠", price: 20, atlas: "extra", col: 2, row: 1 },
    chihuahua: { name: "치와와", price: 20, atlas: "extra", col: 0, row: 2 },
    welsh_corgi: { name: "웰시코기", price: 20, atlas: "extra", col: 1, row: 2 },
    husky: { name: "허스키", price: 20, atlas: "extra", col: 2, row: 2 },
  },
  companion: {
