(function attachGameEngine(root, factory) {
  ...
  function addDrop(state, kind, options = {}) {
    ...
    state.drops.push({
      ...
      y: options.y ?? -40,
      width: options.width ?? (isBomb ? 42 : isBox ? 46 : isToy ? 42 : isHand ? 58 : isCatnip ? 46 : isTuna ? 44 : isClipper ? 48 : isHeart ? 42 : isGold ? 34 : 28),
      height: options.height ?? (isBomb ? 42 : isBox ? 38 : isToy ? 42 : isHand ? 42 : isCatnip ? 46 : isTuna ? 42 : isClipper ? 34 : isHeart ? 38 : isGold ? 70 : 60),
